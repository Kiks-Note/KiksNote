...
export default function BoardReview() {
  ...
  const sendAddedPostIt = async (newObjPostIt, columnId) => {
    axios.post(`${process.env.REACT_APP_SERVER_API}/retro/addPostIt`, {
  ...
  const sendEditPostit = async (categorie, selectedPostItIndex, postItText) => {
    ...
    await axios.put(`${process.env.REACT_APP_SERVER_API}/retro/editPostit`, {
      categorie: categorie,
  ...
  const sendMovePostIt = async (source, destination) => {
    axios.put(`${process.env.REACT_APP_SERVER_API}/retro/movePostIt`, {
      source: source,
                              ...
                              {(provided, snapshot) => {
                                return (
                                  <div
                                    ...
                                    onClick={() =>
                                      setRightPostItCategorie(column, index)
                                    }
                                  >
