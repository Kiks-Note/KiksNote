          ...
          >
            ...
            <Typography variant="h6">
              {userProfil.job ? (
                ...
                <>Travail chez {userProfil.company}</>
              ) : (
                <></>
              )}
            </Typography>
              ...
              <div style={{ height: "40%", marginBottom: "10%" }}>
                ...
                <Box className="itemBox">
                  ...
                  >
                    ...
                    <Typography variant="h6">{userProfil.email}</Typography>
                  </div>
                  <div
                    style={{
                      display: "flex",
                  ...
                  >
                    ...
                    <Typography variant="h6">{userProfil.phoneNumber}</Typography>
                  </div>
                  <div
                    style={{
                      display: "flex",
                  ...
                  >
                    ...
                    <Typography variant="h6">{userProfil.discord}</Typography>
                  </div>
                  <Typography>
                    <Typography variant="h6">Langages de programmation : </Typography>
                    <div style={{ lineHeight: "0", display: "flex", flexWrap: "wrap" }}>
              ...
              <div>
                ...
                <Box className="itemBox">
                  <div style={{ display: "flex" }}>
                    ...
                    <a href={userProfil.linkedin} target="_blank" style={{ marginLeft: "5%" }}>
                  ...
                  <div style={{ display: "flex" }}>
                    ...
                    <a href={userProfil.git} target="_blank" style={{ marginLeft: "5%" }}>
