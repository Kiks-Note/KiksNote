...
function BlogRepartition() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get("http://localhost:5050/blog/stats/distribution");
            ...
            console.error("Erreur lors de la récupération des données de répartition des créations :", error);
        }
    };
